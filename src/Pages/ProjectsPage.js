                ...
                <Row xs={1} lg={2} className="mb-3 border-bottom">
                    <Col className="my-auto d-flex">
                        <Container className="align-middle text-center text-lg-start">
                            <h1>Projects</h1>
                            <h3>I've worked on plenty of projects in pursuit of my goal. The ones' I'm most proud of are as follows</h3>
                        </Container>
                    </Col>
                    <Col>
                ...
                <Row xs={1} className="d-block d-lg-none gy-5 gx-3 py-5">
                    <Col>
                        <ProjectsCards
                            ...
                            <a href="https://github.com/Crufixs/SE_BeanAndBean" target="_blank">
                                <center>
                                    <Card.Img variant="top" className="thumbnail rounded-circle" src={sample} />
                                </center>
                            </a>
                        </ProjectsCards>
                    </Col>
                    <Col>
                        <ProjectsCards title="Captain Puppy"
                    ...
                    <Col>
                        <ProjectsCards
                            ...
                            <a href="https://github.com/Crufixs/Email-Application" target="_blank">
